...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 19 mars 2019 à 23:34
...
(1, 'Comité de direction', NULL, 'pole', NULL, NULL),
(2, 'Conseil de laboratoire', NULL, 'pole', NULL, NULL),
(3, 'Direction', NULL, 'pole', NULL, NULL),
(4, 'Service d\'appui', 1, 'service', NULL, NULL),
(5, 'Mécanique', 4, 'service', NULL, NULL),
(6, 'Electronique', 4, 'service', NULL, NULL),
(7, 'Instrumentation', 4, 'service', NULL, NULL),
(8, 'Calcul scientifique', 4, 'service', NULL, NULL),
(9, 'Service d\'accompagnement', 3, 'service', NULL, NULL),
(10, 'Administratif et financier', 9, 'service', NULL, NULL),
(11, 'Ressources informatiques', 9, 'service', NULL, NULL),
(12, 'Hygiène et sécurité', 9, 'service', NULL, NULL),
(13, 'Infrastructure', 9, 'service', NULL, NULL);
...
INSERT INTO `compte` (`id`, `login`, `password`, `role`, `home_directory`, `startdate`, `enddate`) VALUES
(1, 'root@root.com', 'root', 1, 'non', NULL, NULL),
(2, 'test@test.com', 'test', 2, 'non', NULL, NULL);
...
(1, 'Aadministrateur', 'Administrateur', NULL, 'Orsay', '0101010101', '0606060606', 'root@root.com', 1, 'lri', '', 1, NULL, NULL, '0000-00-00 00:00:00', 1),
(2, 'User', 'User', NULL, 'Orsay', '0101010101', '0606060606', 'root@root.com', 7, 'Gustave eiffel', '', 1, NULL, NULL, '0000-00-00 00:00:00', 2);
...
ALTER TABLE `compte`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNIQ_CFF6526057698A6A` (`role`);
...
ALTER TABLE `workon`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNIQ_715C0BA7FCEC9EF` (`personne`),
  ADD UNIQUE KEY `UNIQ_715C0BA7B8755515` (`activite`);
